  ...
  return (
    <main className="flex flex-col items-center gap-10 bg-[url(/background.webp)] bg-cover">
      ...
      <section className="flex flex-col items-center gap-4">
        ...
        <p className="mx-5 text-center text-xs/6 md:mx-30">
          <span className="mb-3 block">
            As a passionate software engineer, I thrive on theintricate dance
            between logic and creativity. Currently immersed in the dynamic
            world of WebHR, my expertise centers around React Native, where I
      ...
      <section className="flex flex-col items-center gap-4">
        ...
        <p className="mx-5 text-center text-xs/6 md:mx-30">
          <span className="mb-3 block">
            Currently, I am working on WebHR Mobile Application, WebHR is a
            Cloud based Social HR Software for SMEs by Verge Systems Inc. WebHR
            is currently used in over 160 countries world wide by thousands of
          ...
          <span>
            ...
            cross-platform mobile applications that run seamlessly on both iOS
            and Android platforms. Additionally, my proficiency in React.js has
            equipped me with the skills to create fast, scalable, and dynamic
            web pages with excellent user experiences. I have a deep
            understanding of component-based architecture and state management,
            and I am well-versed in the latest web development trends and
            technologies.
          </span>
        </p>
      ...
      <section className="flex flex-col items-center gap-4">
        ...
        <h3 className="text-gradient text-center">EXPLORE NOW</h3>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 w-4/5">
          <Project
            title="WebHR"
            imgUrl="/image-2.webp"
